...
changed until they reached a steady state. The resulting PageRank scores are:
...
\noindent NOTE: REWRITE THIS PART IT SOUNDS WEIRD
\noindent Pages~4--6 dominate the steady-state distribution, whereas Pages~1--3
decay to zero in the same limit. Page 4 having the highest PageRank score of $4/9$ means 
it is the most frequently visited node and most dominant page in the network. This 
behavior matches the convergence pattern shown in Figure~\ref{fig:conv1}.
