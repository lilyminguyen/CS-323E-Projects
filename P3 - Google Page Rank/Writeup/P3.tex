...
values and assumed that each page is equally likely to be visited from the
start:
\begin{equation}
    \boldsymbol{x}_0=
        \begin{pmatrix}
...
through the web graph following links. We visualized the convergence of the PageRank vector by 
plotting each page's rank score at each ieration, which allowed us to track how the scores
