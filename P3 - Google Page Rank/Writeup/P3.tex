...
\keywords{stochastic matrix --- hyperlink --- directed graph --- word4 --- word5}
...
In this project, we implemented the PageRank algorithm on two web graphs using
both an iterative difference equation and the dominant eigenvector method. Our
results agreed in both cases, which confirms the theoretical convergence
